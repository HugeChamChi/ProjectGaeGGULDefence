...
///
/// 기본 공격 (투사체 — 매직 미사일):
///   unitData.basicAttackData(SD_매직미사일, MultiShotSkillAction+DamageHitEffect)로 데이터
...
///
///   unitData.skillData(MultiShotSkillAction + DamageHitEffect)로 데이터 정의되어 있습니다.
///   DamageHitEffect.fixedPower(500/1500/2500/3500, 티어별)가 0보다 크면 공격력 대신 이
///   고정값을 UnitStatsModifier.ComputeDamage와 동일한 보정 파이프라인에 통과시켜 데미지로
///   사용합니다. 스킬 투사체 크기(150%~300%, 티어별)도 같은 SkillData의 sizeMultiplier로
