...
///
/// 기본 공격 (투사체 — 쿠나이 투척):
///   unitData.basicAttackData(SD_쿠나이투척, MultiShotSkillAction+DamageHitEffect)로 데이터
///   정의되어 있습니다 (atk 비례 피해, coefficient=1).
///
/// 액티브 스킬 (그림자 표창): unitData.skillData(MultiShotSkillAction+DamageHitEffect)로
///   데이터 정의되어 있으며(DamageHitEffect.coefficient=80%, shotCount=2,
